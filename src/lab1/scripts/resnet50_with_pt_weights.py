...
# with open(base_path + 'pkls/histandtrainedmods/resnet50_with_pt_weights_history.pkl', 'wb') as f:
#     pickle.dump(history, f)
# with open(base_path + 'pkls/histandtrainedmods/resnet50_with_pt_weights_trainedmodel.pkl', 'wb') as f:
#     pickle.dump(finalmodel, f)

# option to load saved history and trained model directly - comment if training again
# with open(base_path + 'pkls/histandtrainedmods/resnet50_with_pt_weights_history.pkl', 'rb') as f:
#     history = pickle.load(f)
# with open(base_path + 'pkls/histandtrainedmods/resnet50_with_pt_weights_trainedmodel.pkl', 'rb') as f:
...
with open(base_path + 'savedmodels/resnet50_with_pt_weights.json', 'w') as json_file:
...
plt.savefig(base_path + 'savedmodels/mame_resnet50_with_pt_weights_accuracy.pdf')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train','val'], loc='upper left')
plt.savefig(base_path + 'savedmodels/mame_resnet50_with_pt_weights_loss.pdf')
...
conf_fig.get_figure().savefig(base_path + 'savedmodels/mame_resnet50_with_pt_weights_test_confusion_matrix.pdf', dpi=400)
