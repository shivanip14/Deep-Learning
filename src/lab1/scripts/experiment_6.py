...
model1 = Conv2D(16, (3, 3), activation='relu', padding="same") (model)
model2 = Conv2D(16, (3, 3), activation='relu', padding="same") (model)
...
with open(base_path + 'savedmodels/json/exp_6.json', 'w') as json_file:
        json_file.write(finalmodel.to_json())
weights_file = base_path + 'savedmodels/weights/weights-MAMe-exp_6_'+str(preds_test[1])+'.hdf5'
...
plt.savefig(base_path + 'savedmodels/accuracy/exp_6_accuracy.pdf')
plt.close()
