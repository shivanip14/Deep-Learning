...
# loading VGG16 model from keras
loaded_model = VGG16(include_top=False, weights=base_path + '/savedmodels/weights/vgg16-base-no-top.h5', input_shape=(256, 256, 3))

print('Pre-trained VGG16 model:\n')
loaded_model.summary()

final_model = fine_tune_model(loaded_model, delay_loading_weights, base_model_exp)

print('Fine-tuned VGG16 model:\n')
final_model.summary()
