...
# loading EfficientNet model from keras
loaded_model = EfficientNetB2(include_top=False, weights=base_path + '/savedmodels/weights/efficientnet-base-no-top.h5', input_shape=(256, 256, 3))

print('Pre-trained EfficientNet model:\n')
loaded_model.summary()

final_model = fine_tune_model(loaded_model, delay_loading_weights, base_model_exp)

print('Fine-tuned EfficientNet model:\n')
final_model.summary()
