...
#SBATCH --job-name="feature_extraction_exps"
#SBATCH -D .
#SBATCH --output=feature_extraction_exps_%j.out
#SBATCH --error=feature_extraction_exps_%j.err
#SBATCH --ntasks=40
#SBATCH --gres=gpu:1
...
python fe_pretrained_runner.py $1 $2 $3
